...
Imports DevExpress.DocumentServices.ServiceModel.ServiceOperations
...
Namespace T155725
    Friend Class Program
        Shared Sub Main(ByVal args() As String)
            ...
            Dim parameter As New ReportParameter() With {.Name = "@CustomerID", .Path = "@CustomerID", .Value = "ALFKI"}
